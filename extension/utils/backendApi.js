    ...
    try {
      ...
      try {
        ...
        if (allLinks.length > 0) {
          ...
          console.log('[SRT] getCategories: Processing links', {
            totalLinks: allLinks.length,
            activeLinks: activeLinks.length,
            archivedLinks: allLinks.length - activeLinks.length
          });
          ...
          console.log('[SRT] getCategories: Categories extracted from active links', {
          ...
          console.log('[SRT] getCategories: User-created categories (after filtering predefined)', {
