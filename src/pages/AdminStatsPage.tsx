...
export const AdminStatsPage: React.FC = () => {
  ...
  const generateUsageChartData = async () => {
    try {
      ...
      // Simple data generation for summary display
      const totalLogins = userAudits.length;
      const totalDownloads = 0; // Mock data for now
      const totalInstallations = 0; // Mock data for now
      ...
      setUsageChartData({ dates: [], logins: [0], downloads: [0], installations: [0] });
    }
  };
